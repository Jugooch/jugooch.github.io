...
coverImage: "https://via.placeholder.com/800x500.png?text=ClearStack+AI+Landing+Page"
technologies: ["Vue", "Heroku", "JavaScript", "Figma", "HTML", "CSS"]
links:
  github: "N/A"
  live: "https://www.clearstack.ai/"
gallery:
  - url: "https://via.placeholder.com/800x500.png?text=Design+Mockup"
    caption: "Design Mockup in Figma"
  - url: "https://via.placeholder.com/800x500.png?text=Landing+Page+Screenshot"
