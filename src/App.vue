...
const uiProjects = ref([
  ...
  {
    image: "./src/assets/images/allrecipes-redesign.png",
...
const frontendProjects = ref([
  {
    image: "./src/assets/images/personal-portfolio.png",
    name: "Personal Portfolio",
    description: "Vue, HTML, CSS",
    url: "",
  },
  {
    image: "./src/assets/images/gcu-student-app.png",
...
const backendProjects = ref([
  {
    image: "./src/assets/images/minesweeper.PNG",
